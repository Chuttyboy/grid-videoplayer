...
const actionButton=(params)=>{
  ...
  const columnDefs = [
    ...
    { headerName: "VideoLink", field: "videolink" },
    {
      headerName: "Actions", field: "videolink", cellRendererFramework: (params) => <div>
        <Button variant="contained" size="medium" color="primary" onClick={()=> actionButton(params)} >Update</Button>
